...
class Calculator:
    def __init__(self,master):
        ...
        Button(width=11,height=4,text='=',relief='flat',bg="#ffa500",fg="white",command=self.solve).place(x=270,y=350)
        Button(width=11,height=4,text='C',relief='flat',bg="#ffa500",fg="white",command=self.clear).place(x=0,y=350)
